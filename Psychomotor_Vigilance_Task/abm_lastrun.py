...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='E:\\Projects\\pychopy\\Term 2\\Psychology2\\abm\\abm_lastrun.py',
...
for thisAbm_trial in abm_trials:
    ...
    if dontrespond.keys != None:  # we had a response
        ...
        abm_trials.addData('dontrespond.duration', dontrespond.duration)
    ...
    while continueRoutine:
        ...
        # if up_key is starting this frame...
        ...
        if up_key.status == STARTED and not waitOnFlip:
            ...
            if len(_up_key_allKeys):
                ...
                up_key.duration = _up_key_allKeys[-1].duration
                # a response ends the routine
                continueRoutine = False
    ...
    if up_key.keys != None:  # we had a response
        ...
        abm_trials.addData('up_key.duration', up_key.duration)
